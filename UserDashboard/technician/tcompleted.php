            ...
            <div id="layoutSidenav_content">
              <main><form method="post">
                  <div class="container-fluid px-4">
                      <h1 class="mt-4">Completed Work</h1>
                      <hr>
  ...
  <div class="card-body">
     ...
     <th>Completed On</th>
          ...
          <tbody>
                    <?php
                    $techid=$_SESSION['tid'];
                    $ret=mysqli_query($con,"SELECT * from usercomplain INNER JOIN userlogin ON usercomplain.uid=userlogin.uid and usercomplain.status=1 and usercomplain.tid=$techid;");
