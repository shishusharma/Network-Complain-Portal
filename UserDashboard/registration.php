...
// } else{
    $msg=mysqli_query($con,"insert into userlogin(uid,uname,uemail,upassword,umob,uadd) values('4545454','$name','$email','$pass','$mob','$addr')");
...
<body>
    ...
    <div class="text-center" style="margin-bottom:0;width: 100%;max-height: 100px;background-color: cadetblue;float: left;">
        <div class="container" >
            <div class="row">
                <div class="col-sm-2">
