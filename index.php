            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4  ">
                        <h1 class="mt-4 sm-2">   User Registration & Login and User Management System With admin panel</h1>
                            ...
                            <div class="col-xl-4 col-md-6" >
                                <div class="card bg-primary text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="registration.php">Signup Here</a>
...
<div class="col-xl-4 col-md-6">
                                   <div class="card bg-danger text-white mb-4">
                                                                <div class="card-body">Technicians Panel</div>
                                                                <div class="card-footer d-flex align-items-center justify-content-between">
                                                                    <a class="small text-white stretched-link" href="technician/techlogin.php">Login Here</a>
